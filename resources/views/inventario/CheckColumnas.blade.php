...
<div class="d-flex flex-wrap justify-content-center align-items-center gap-3">
    ...
    <div class="form-check">
        <input class="form-check-input toggle-col" type="checkbox" data-column="6" id="colMotivo">
        <label class="form-check-label" for="colMotivo">Motivo</label>
    </div>

    <div class="form-check">
        <input class="form-check-input toggle-col" type="checkbox" data-column="7" id="colCant" checked>
        <label class="form-check-label" for="colCant">Cant</label>
    </div>

    <div class="form-check">
        <input class="form-check-input toggle-col" type="checkbox" data-column="8" id="colStock" checked>
    ...
    <div class="form-check">
        <input class="form-check-input toggle-col" type="checkbox" data-column="10" id="colTotal" checked>
